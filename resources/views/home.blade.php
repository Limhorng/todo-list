...
<body class="grid place-items-ceneter min-h-screen">
    <div id="app">
        ...
        <title-with-background>Our Works</title-with-background>
        ...
        <div class="text-center-middle-screen">
        ...
        <div class="grid grid-rows-2 grid-cols-2 p-2 gap-4">
            <service-card>
                ...
                <template v-slot:plain-title>50</template>
        ...
        <title-with-background>What Services We Provide</title-with-background>
        <div class="text-center-middle-screen">
            <p>Since 2008, I’ve been providing my clients with quality photography and retouching services.</p>
            <p>Some of my works were awarded on a national level. Below are some facts about me.</p>
        </div>
        <div class="grid grid-cols-1 gap-4 p-3">
            <service-card>
                ...
                <template v-slot:plain-title>Photoshoot</template>
                <template v-slot:description>
        ...
        <title-with-background>Pricing Plan</title-with-background>
        <div class="text-center-middle-screen">
            <p>Since 2008, I’ve been providing my clients with quality photography and retouching services.</p>
            <p>Some of my works were awarded on a national level. Below are some facts about me.</p>
        </div>
